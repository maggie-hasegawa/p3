...
@section('content')
	<div class="jumbotron">
		...
		<p><a href="/lorem" class="btn btn-primary btn-lg">Take me to the text generator</a></p>
	</div>
	<div class="jumbotron">
		...
		<p><a href="/users" class="btn btn-primary btn-lg">Take me to the random user generator</a></p>
	</div>
@stop